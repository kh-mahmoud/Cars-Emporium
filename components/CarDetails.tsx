        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform p-6 overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                    <button type='button' onClick={closeModal} className='absolute top-2 right-2 z-10 rounded-full p-2 bg-primary-blue-100'>
                         <Image
                            src={"/close.svg"}
                            alt='close'
                            width={20}
